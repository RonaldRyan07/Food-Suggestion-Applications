...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        RestrauntAdapter restroAdapter = new RestrauntAdapter(HomeActivity.this,
                userInfoModel, mRestrauntModelList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_view_profile:
                ...
                intent.putExtra("UserProfile", SharedPreferenceManager.
                        readString(SharedPreferenceManager.SIGNIN_USER, ""));

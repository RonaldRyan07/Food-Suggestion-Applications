...
class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.MyViewHolder> {
    ...
    public ReviewAdapter(Activity mActivity, UserInfoModel userInfoModel,
                         List<ReviewModel> mReviewList, IUpdateReviewRating IUpdateReviewRating) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if(holder.mRestrauntName.getText().toString().equals(userInfoModel.getmUserName())) {
...
//                Log.d("katraj", holder.mRestrauntName.toString());
//                if(holder.mRestrauntName.getText().toString().equals(userInfoModel.getmUserName())) {
...
//                }
        ...
        holder.mUpdateRating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.mUpdateRating.setVisibility(View.GONE);
            }
        });
